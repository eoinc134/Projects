public class UsefulMethods {
    /*
     * This is a collection of useful or utility methods that
     * can be used by ANY program that has access to the class.
     * 
     * To use one of the methods simply include a reference 
     *       - to the class and 
     *       - the method 
     * as follows
     * 
     *         UsefulMethods.generatePassword()
     *         UsefulMethods.generatePassword(4)
     *         UsefulMethods.generatePassword(8,"abcd...7890")
     *         UsefulMethods.jumble("put your name or any other text here")
     *         UsefulMethods.scrabbleWordScore(stringVarContainingWord)
     */
	public static String generatePassword() {
        String alphabet, password ;
        int i, pos;
        ...
        for(i= 0 ; i < 8 ; i++) {
            ...
            password = password + alphabet.charAt(pos) ;
        }
        return password ;
    }
    ...
    public static String generatePassword(int passwordLen, String alphabet) {
        String password ;
        int i, pos;
